...
int main(int argc, char* argv[]) {
  ...
  argparse::ArgumentParser program("g2_pos_swing");
  ...
  program.add_argument("-T").scan<'g', double>().default_value(10);
  ...
  double T = program.get<double>("-T");
  double eef_pos = 0.0;
  if (T < 0.0) {
    std::cout << "T must bugger than 0" << std::endl;
    return 0;
  }
